...
public class SimpleRecipeWrapper implements IRecipeWrapper {
    // Used for 1 input -> 1 output recipes, like most Simple Recipes and a few others like the Fuel
    // Processor
    ...
    public SimpleRecipeWrapper(ItemStack input, ItemStack output, int ticks, IGuiHelper guiHelper) {
        ...
        arrow = guiHelper.createAnimatedDrawable(
                ProdigyTechJEI.getDefaultProcessArrow(guiHelper), ticks, IDrawableAnimated.StartDirection.LEFT, false);
    }
