...
public class ProdigyTechJEI implements IModPlugin {
    ...
    public void register(IModRegistry registry) {
        ...
        if (Config.incineratorChance > 0 && Config.incineratorJEI)
            registry.addRecipeCatalyst(new ItemStack(ModBlocks.incinerator), IncineratorCategory.UID);
        ...
        registry.addRecipeClickArea(
                GuiExplosionFurnace.class,
                79,
                34,
                42,
                17,
                ExplosionFurnaceCategory.UID,
                ExplosionFurnaceExplosiveCategory.UID,
                ExplosionFurnaceDampenerCategory.UID);
        if (Config.incineratorChance > 0 && Config.incineratorJEI)
            registry.addRecipeClickArea(GuiIncinerator.class, 79, 35, 24, 17, IncineratorCategory.UID);
