...
public class IncineratorCategory extends ProdigyCategory<IncineratorWrapper> {
    ...
    public IncineratorCategory(IGuiHelper guiHelper) {
        super(
                guiHelper,
                guiHelper
                        .drawableBuilder(ProdigyTechJEI.GUI, 0, 36, 82, 26)
                        .addPadding(0, (int) (Config.incineratorChance * 100) >= 100 ? 0 : 10, 0, 0)
                        .build(),
                UID);

        this.arrow = guiHelper.createAnimatedDrawable(
                ProdigyTechJEI.getDefaultProcessArrow(guiHelper),
                Config.incineratorProcessTime,
    ...
    public void setRecipe(IRecipeLayout recipeLayout, IncineratorWrapper recipeWrapper, IIngredients ingredients) {
        ...
        allItemIngredient = new GuiIngredient<>(
                0,
                true,
                ProdigyTechJEI.stackRenderer,
                ProdigyTechJEI.stackHelper,
