...
public class ExplosionFurnaceDampenerCategory extends ProdigyCategory<ExplosionFurnaceDampenerWrapper> {
    ...
    public ExplosionFurnaceDampenerCategory(IGuiHelper guiHelper) {
        super(
                guiHelper,
                guiHelper
                        .drawableBuilder(GuiExplosionFurnace.GUI, 16, 43, 18, 18)
    ...
    public void setRecipe(
            IRecipeLayout recipeLayout, ExplosionFurnaceDampenerWrapper recipeWrapper, IIngredients ingredients) {
    ...
    public static void registerRecipes(IModRegistry registry) {
        ...
        ExplosionFurnaceManager.DAMPENERS.getAllContent().stream()
                .sorted(Comparator.comparingInt(Dampener::getDampening))
                .forEach(e -> list.add(new ExplosionFurnaceDampenerWrapper(e)));
        ;
