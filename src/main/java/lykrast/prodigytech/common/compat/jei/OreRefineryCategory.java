...
public class OreRefineryCategory extends ProdigyCategory<SimpleRecipeSecondaryOutputWrapper> {
    ...
    public OreRefineryCategory(IGuiHelper guiHelper) {
        super(
                guiHelper,
                guiHelper
                        .drawableBuilder(ProdigyTechJEI.GUI, 0, 36, 104, 26)
                        .addPadding(0, 10, 0, 0)
                        .build(),
                UID);
    }
    ...
    public void setRecipe(
            IRecipeLayout recipeLayout, SimpleRecipeSecondaryOutputWrapper recipeWrapper, IIngredients ingredients) {
    ...
    public static void registerRecipes(IModRegistry registry) {
        ...
        recipes.stream()
                .sorted()
                .forEachOrdered(recipe -> list.add(new SimpleRecipeSecondaryOutputWrapper(recipe, guiHelper)));
