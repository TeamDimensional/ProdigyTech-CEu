                ...
                if (processing) {
                    ...
                    if (target.getBlock() == ModBlocks.energionCrystal && BlockEnergionCrystal.getAge(target) > 0) {
                        if (processTime <= 0) {
                            ...
                            if (stack.isEmpty())
                                setInventorySlotContents(0, new ItemStack(ModItems.energionCrystalSeed));
                            else stack.grow(1);

                            int age = BlockEnergionCrystal.getAge(target);
                            world.playEvent(2001, targetPos, Block.getStateId(target));
                            world.setBlockState(
                                    targetPos, ((BlockEnergionCrystal) ModBlocks.energionCrystal).withAge(age - 1));
                    ...
                    if (clockTime <= 1) {
                        ...
                        if (target.getBlock() == ModBlocks.energionCrystal
                                && BlockEnergionCrystal.getAge(target) >= 5) {
