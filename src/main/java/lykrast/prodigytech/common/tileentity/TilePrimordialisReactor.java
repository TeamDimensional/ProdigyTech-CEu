...
public class TilePrimordialisReactor extends TileMachineInventory implements ITickable, IProcessing {
    ...
    private IItemHandlerModifiable invHandler = new ProdigyInventoryHandler(
            this, 10, 0, new boolean[] {true, true, true, true, true, true, true, true, true, false}, new boolean[] {
