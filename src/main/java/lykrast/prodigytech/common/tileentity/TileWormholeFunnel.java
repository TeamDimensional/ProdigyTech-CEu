...
public class TileWormholeFunnel extends TileEntity implements IHotAir {
    ...
    /** Attempts to create a link with the targeted position. Does not check for range. */
    ...
    public boolean hasCapability(Capability<?> capability, EnumFacing facing) {
        if (capability == CapabilityHotAir.HOT_AIR && (facing == EnumFacing.UP || facing == null) && !down) return true;
