...
public abstract class SimpleRecipeManagerAbstract<T extends ISingleInputRecipe> {
    ...
    /**
     * Find a recipe whose input matches the given ItemStack. This also checks for any Ore Dictionary
     * Tag the stack may have.
     *
     * @param in ItemStack to find a recipe for
     * @return found recipe, or null if none is found
     */
    @Nullable public T findRecipe(ItemStack in) {
     ...
     */
    @Nullable public T removeRecipe(ItemStack in) {
     ...
     * @return found and removed recipe, or null if none is found
     */
    @Nullable public T removeOreRecipe(String in) {
        return recipes.remove(in);
    }
    ...
    /**
     * Check if a given ItemStack is a valid input for this Manager. Both the item itself and its Ore
     * Dictionary tags are checked.
     *
