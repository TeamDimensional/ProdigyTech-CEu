...
public class RotaryGrinderManager extends SimpleRecipeManager {
    ...
    public void init() {
        ...
        if (RecipeUtil.itemExists("exnihilocreatio:block_netherrack_crushed"))
            addRecipe(
                    "netherrack",
                    new ItemStack(RecipeUtil.getExteriorItem("exnihilocreatio:block_netherrack_crushed")));
        ...
        addRecipe(
                new ItemStack(Blocks.RED_SANDSTONE, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.SAND, 2, 1));
        ...
        addRecipe(
                new ItemStack(Blocks.PRISMARINE, 1, BlockPrismarine.ROUGH_META),
                new ItemStack(Items.PRISMARINE_SHARD, 4));
        addRecipe(
                new ItemStack(Blocks.PRISMARINE, 1, BlockPrismarine.BRICKS_META),
        ...
        addRecipe(new ItemStack(Blocks.QUARTZ_STAIRS), new ItemStack(ModItems.quartzDust, 6), (int)
                (Config.rotaryGrinderProcessTime * 6));
        addRecipe(
                new ItemStack(
                        Blocks.STONE_SLAB,
                        1,
                        Blocks.STONE_SLAB.getMetaFromState(Blocks.STONE_SLAB
                                .getDefaultState()
                                .withProperty(BlockStoneSlab.VARIANT, BlockStoneSlab.EnumType.QUARTZ))),
                new ItemStack(ModItems.quartzDust, 2),
                Config.rotaryGrinderProcessTime * 2);
        ...
        //		addRecipe("gemBigEnergion", new ItemStack(ModItems.energionDust, 6),
        // Config.rotaryGrinderProcessTime * 6);
        //		addRecipe("blockEnergion", new ItemStack(ModItems.energionDust, 54),
        // Config.rotaryGrinderProcessTime * 54);
