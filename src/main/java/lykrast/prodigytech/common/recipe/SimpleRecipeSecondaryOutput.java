...
public class SimpleRecipeSecondaryOutput extends SimpleRecipe {
    ...
    public SimpleRecipeSecondaryOutput(
            ItemStack input, ItemStack output, ItemStack secondaryOutput, int time, float secondaryChance) {
    ...
    public SimpleRecipeSecondaryOutput(
            String inputOre, ItemStack output, ItemStack secondaryOutput, int time, float secondaryChance) {
