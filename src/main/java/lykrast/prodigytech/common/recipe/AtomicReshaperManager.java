...
public class AtomicReshaperManager extends SimpleRecipeManagerAbstract<AtomicReshaperRecipe> {
    ...
    public void init() {
        addRecipe(
                "treeSapling",
                Config.atomicReshaperProcessTime,
                new InfusionCost("primordium", 50),
                new ItemStack(ModBlocks.zorraSapling));
        // Using Botania's Orechid weights
        addRecipe(
                "stone",
                Config.atomicReshaperProcessTime,
                new InfusionCost("primordium", 20),
        ...
        addRecipe(
                "sand",
                Config.atomicReshaperProcessTime,
                new InfusionCost("primordium", 1),
                new ItemStack(Blocks.DIRT));
        addRecipe(
                "dirt",
                Config.atomicReshaperProcessTime,
                new InfusionCost("primordium", 3),
                new ItemStack(Blocks.CLAY));
        addRecipe(
                "paper",
                Config.atomicReshaperProcessTime,
                new InfusionCost("primordium", 2),
        ...
        addRecipe(
                ...
                Config.atomicReshaperProcessTime,
                new InfusionCost("primordium", 5),
                new ItemStack(ModItems.aeternusCrystal));
    }
                ...
                for (int i = 0; i < args.length; i += 2) {
                    if (!(args[i] instanceof ItemStack) || !(args[i + 1] instanceof Integer))
                        throw new IllegalArgumentException(
                                "Output arguments must be alternating between ItemStacks and integers, in that order");
