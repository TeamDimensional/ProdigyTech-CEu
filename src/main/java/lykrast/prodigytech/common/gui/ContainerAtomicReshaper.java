...
public class ContainerAtomicReshaper extends ContainerMachine<TileAtomicReshaper> {
    ...
    private int primordium, infusionId;
    ...
    public ContainerAtomicReshaper(InventoryPlayer userInv, TileAtomicReshaper tile) {
        ...
        this.addSlotToContainer(new Slot(tile, 0, 8, 53) {
            ...
            public boolean isItemValid(ItemStack stack) {
                return tile.getInfusionState()
                        .validInput(Infusion.getInfusionOutput(TileAtomicReshaper.MACHINE_NAME, stack));
            }
        });
        // Input
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            // Inventory slots
                ...
                // Primordium
                if (tile.getInfusionState()
                        .validInput(Infusion.getInfusionOutput(TileAtomicReshaper.MACHINE_NAME, itemstack1))) {
