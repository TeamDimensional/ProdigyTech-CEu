...
public class TooltipUtil {
    ...
    /**
     * Adds the item's tooltip to the itemstack, following localization. <br>
    ...
    /**
     * Adds a tooltip stating to hold SHIFT for extended information. <br>
     * Returns true if the key is hold and more tooltips should be added. <br>
     * This is intended to be called in addInformation.
     *
