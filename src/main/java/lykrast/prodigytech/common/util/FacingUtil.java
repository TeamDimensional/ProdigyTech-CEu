...
public class FacingUtil {
    ...
    /**
     * Returns an array of facing to iterate over for a round robin that excludes the given side. <br>
     * This starts with the opposite side first, then turns clockwise on the perpendicular plane from
     * the perspective of the excluded side. <br>
     * This second part starts up for horizontal facings, north when up is excluded, and south when
     * down is excluded.
     *
     * @param exclude
     * @return
