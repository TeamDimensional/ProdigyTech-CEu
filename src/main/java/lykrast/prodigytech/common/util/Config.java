...
public class Config {
    ...
    public static int incineratorProcessTime,
            blowerFurnaceProcessTime,
            rotaryGrinderProcessTime,
            heatSawmillProcessTime,
            foodPurifierBaseTime,
            soldererProcessTime,
            magneticReassemblerProcessTime,
            oreRefineryProcessTime,
            automaticCrystalCutterHarvestTime,
            automaticCrystalCutterIdleTime,
            capacitorChargerChargeTime,
            fuelProcessorBaseTime,
            foodEnricherBaseTime,
            primordialisReactorCycleTime,
            atomicReshaperProcessTime;
    ...
    private static void initGeneralConfig(Configuration cfg) {
        ...
        // -----------
        // Incinerator
        incineratorProcessTime = cfg.getInt(
                "incineratorProcessTime",
                CATEGORY_MACHINES,
                200,
                1,
                3000,
                "The base amount of time (in ticks) that the Incinerator takes to process 1 item");
        incineratorChance = cfg.getFloat(
                "incineratorChance",
                CATEGORY_MACHINES,
                1.0F,
                0,
        ...
        incineratorJEI =
                cfg.getBoolean("incineratorJEI", CATEGORY_MACHINES, true, "Show the Incinerator recipe for Ash in JEI");
        // Blower Furnace
        blowerFurnaceProcessTime = cfg.getInt(
                "blowerFurnaceProcessTime",
                CATEGORY_MACHINES,
                300,
                1,
        ...
        // Rotary Grinder
        rotaryGrinderProcessTime = cfg.getInt(
                "rotaryGrinderProcessTime",
                CATEGORY_MACHINES,
                300,
                1,
        ...
        rotaryGrinderOreMultiplier = cfg.getInt(
                "rotaryGrinderOreMultiplier",
                CATEGORY_MACHINES,
                2,
                1,
                10,
                "By how much ore outputs are multiplied by when passing them through the Rotary Grinder");
        autoOreRecipes = cfg.getBoolean(
                "autoOreRecipes",
                CATEGORY_MACHINES,
                true,
        ...
        // HeatSawmill
        heatSawmillProcessTime = cfg.getInt(
                "heatSawmillProcessTime",
                CATEGORY_MACHINES,
                200,
                1,
        ...
        heatSawmillPlankMultiplier = cfg.getFloat(
                "heatSawmillPlankMultiplier",
                CATEGORY_MACHINES,
                1.5F,
                1.0F,
                10.0F,
                "Multiplier to the amount of planks the Heat Sawmil can extract from a single log (compared to manual crafting)");
        heatSawmillStickMultiplier = cfg.getFloat(
                "heatSawmillStickMultiplier",
                CATEGORY_MACHINES,
                2.0F,
                1.0F,
                10.0F,
                "Multiplier to the amount of planks the Heat Sawmil can extract from a single log (compared to manual crafting)");
        heatSawmillAutoPlankRecipes = cfg.getBoolean(
                "heatSawmillAutoPlankRecipes",
                CATEGORY_MACHINES,
                true,
        ...
        // Food Purifier
        foodPurifierBaseTime = cfg.getInt(
                "foodPurifierBaseTime",
                CATEGORY_MACHINES,
                10,
                1,
        ...
        magneticReassemblerProcessTime = cfg.getInt(
                "magneticReassemblerProcessTime",
                CATEGORY_MACHINES,
                300,
                1,
                ...
                "The base amount of time (in ticks) that the Magnetic Reassembler takes to process 1 item\n"
                        + "Several recipes have shorter or longer processing time, which are all derived from this value");
        // Ore Refinery
        oreRefineryProcessTime = cfg.getInt(
                "oreRefineryProcessTime",
                CATEGORY_MACHINES,
                100,
                1,
        ...
        oreRefineryOreMultiplier = cfg.getInt(
                "oreRefineryOreMultiplier",
                CATEGORY_MACHINES,
                2,
                1,
                10,
                "By how much ore outputs are multiplied by when passing them through the Ore Refinery");
        oreRefineryChance = cfg.getFloat(
                "oreRefineryChance",
                CATEGORY_MACHINES,
                0.25F,
                0,
        ...
        automaticCrystalCutterHarvestTime = cfg.getInt(
                "automaticCrystalCutterHarvestTime",
                CATEGORY_MACHINES,
                100,
                1,
        ...
        automaticCrystalCutterIdleTime = cfg.getInt(
                "automaticCrystalCutterIdleTime",
                CATEGORY_MACHINES,
                60,
                1,
        ...
        // Heat Accumulator
        capacitorChargerChargeTime = cfg.getInt(
                "capacitorChargerChargeTime",
                CATEGORY_MACHINES,
                30,
                20,
        ...
        // Fuel Processor
        fuelProcessorBaseTime = cfg.getInt(
                "fuelProcessorBaseTime",
                CATEGORY_MACHINES,
                60,
                1,
        ...
        // Food Enricher
        foodEnricherBaseTime = cfg.getInt(
                "foodEnricherBaseTime",
                CATEGORY_MACHINES,
                20,
                1,
        ...
        foodEnricherFoodIncrease = cfg.getInt(
                "foodEnricherFoodIncrease",
                CATEGORY_MACHINES,
                2,
                1,
                20,
                "How much does one Food Enricher operation increases the food value (in half shanks)");
        foodEnricherFoodCap = cfg.getInt(
                "foodEnricherFoodCap",
                CATEGORY_MACHINES,
                20,
                1,
        ...
        foodEnricherSaturationIncrease = cfg.getFloat(
                "foodEnricherSaturationIncrease",
                CATEGORY_MACHINES,
                0.1F,
                0,
                2.0F,
                "How much does one Food Enricher operation increases the saturation ratio");
        foodEnricherSaturationCap = cfg.getFloat(
                "foodEnricherSaturationCap",
                CATEGORY_MACHINES,
                1.2F,
                0,
                10,
        ...
        primordialisReactorCycleTime = cfg.getInt(
                "primordialisReactorCycleTime",
                CATEGORY_MACHINES,
                60,
                1,
        ...
        primordialisReactorRequiredInput = cfg.getInt(
                "primordialisReactorRequiredInput",
                CATEGORY_MACHINES,
                576,
                9,
                5760,
        ...
        // Atomic Reshaper
        atomicReshaperProcessTime = cfg.getInt(
                "atomicReshaperProcessTime",
                CATEGORY_MACHINES,
                200,
                1,
                ...
                "The base amount of time (in ticks) that the Atomic Reassembler takes to process 1 item\n"
                        + "Several recipes have shorter or longer processing time, which are all derived from this value");
        atomicReshaperCapacity = cfg.getInt(
                "atomicReshaperMaxPrimordium",
                CATEGORY_MACHINES,
                400,
                100,
                10000,
        ...
        // Power gen
        // -----------
        energionGrowthSpeed = cfg.getFloat(
                "energionGrowthSpeed",
                CATEGORY_POWER,
                4,
                0.1F,
        ...
        heatCapacitorDuration = cfg.getInt(
                "heatCapacitorDuration",
                CATEGORY_POWER,
                10 * 60 * 20,
                20,
                1728000,
