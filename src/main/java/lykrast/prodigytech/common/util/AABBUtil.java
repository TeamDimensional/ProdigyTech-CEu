...
public class AABBUtil {
    ...
    /**
     * Creates a bounding box using texture pixel measurements instead of raw values. <br>
    ...
    /**
     * Creates a bounding box that's vertically symmetrical and is put on the ground. <br>
