...
public class BlockAirFunnel extends BlockGeneric implements ITileEntityProvider, ICustomItemBlock {
    ...
    /**
     * Get the geometry of the queried face at the given position and state. This is used to decide
     * whether things like buttons are allowed to be placed on the face, or how glass panes connect to
     * the face, among other things.
     *
     * <p>Common values are {@code SOLID}, which is the default, and {@code UNDEFINED}, which
     * represents something that does not fit the other descriptions and will generally cause other
     * things not to connect to the face.
     *
