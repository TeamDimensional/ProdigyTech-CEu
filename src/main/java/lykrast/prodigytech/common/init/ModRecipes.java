        ...
        for (String name : OreDictionary.getOreNames()) {
            ...
            // nugget -> Rotary Grinder processes into dustTiny
                ...
                if (RecipeUtil.oreExists("dustTiny" + ore)) {
                    RotaryGrinderManager.INSTANCE.addRecipe(
                            name,
                            RecipeUtil.getPreferredOreStack("dustTiny" + ore),
                            Config.rotaryGrinderProcessTime / 9);
                }
            }
            ...
            // dustTiny -> Magnetic Reassembler processes into nugget
                ...
                if (RecipeUtil.oreExists("nugget" + ore)) {
                    MagneticReassemblerManager.INSTANCE.addRecipe(
                            name,
                            RecipeUtil.getPreferredOreStack("nugget" + ore),
                            Config.magneticReassemblerProcessTime / 9);
                }
            }
            ...
            // else if (name.startsWith("crop") || name.startsWith("seed"))
            // PrimordialisReactorManager.addInput(name);
        }
    }
