...
public class ModBlocks {
    ...
    static {
        ...
        // Materials
        ferramicBlock = initBlock(
                new BlockGeneric(Material.IRON, SoundType.METAL, 6.0F, 45.0F, "pickaxe", 1), "ferramic_block");
        carbonPlateBlock = initBlock(
                new BlockGeneric(Material.ROCK, SoundType.STONE, 3.0F, 30.0F, "pickaxe", 1), "carbon_plate_block");
        zorrasteelBlock = initBlock(
                new BlockGeneric(Material.IRON, SoundType.METAL, 6.0F, 180.0F, "pickaxe", 3), "zorrasteel_block");

        // Decoration
        charredCobblestone = initBlock(
                new BlockGeneric(Material.ROCK, SoundType.STONE, 2.0F, 10.0F, "pickaxe", 0), "charred_cobblestone");
        charredStone =
                initBlock(new BlockGeneric(Material.ROCK, SoundType.STONE, 1.5F, 10.0F, "pickaxe", 0), "charred_stone");
        charredStoneBricks = initBlock(
                new BlockGeneric(Material.ROCK, SoundType.STONE, 1.5F, 10.0F, "pickaxe", 0), "charred_stonebricks");
        ashBricks =
                initBlock(new BlockGeneric(Material.ROCK, SoundType.STONE, 2.0F, 30.0F, "pickaxe", 0), "ash_bricks");
        particleBoard =
                initBlock(new BlockGeneric(Material.WOOD, SoundType.WOOD, 2.0F, 15.0F, "axe", 0), "particle_board");
        particleBoardPlanks = initBlock(
                new BlockGeneric(Material.WOOD, SoundType.WOOD, 2.0F, 15.0F, "axe", 0), "particle_board_planks");
    }
