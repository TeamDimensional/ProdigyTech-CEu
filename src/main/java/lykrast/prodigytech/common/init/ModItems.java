...
public class ModItems {
    public static Item ferramicIngot,
            ferramicNugget,
            ferramicGear,
            ash,
            purifiedFood,
            ...
            circuitPerfected,
            patternCircuitCrude,
            patternCircuitRefined,
            patternCircuitPerfected,
            heatCapacitor125,
            heatCapacitor250,
            heatCapacitor500,
            heatCapacitor1000,
    ...
    static {
        ...
        // mysteryTreat = initItem(new ItemMysteryTreat(3, 0.8F), "mystery_treat",
        // CreativeTabsMysteryTreats.INSTANCE);
